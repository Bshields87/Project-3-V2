...
import FratContainer from "./FratContainer";
import { withRouter } from "react-router";

class FratOptions extends React.Component {
  constructor(props) {
    super(props);
    this.itemRefs = [];
    this.state = {
  ...
  render() {
    return (
      <FratContainer style={{ ...this.props.style, paddingLeft: "44px" }}>
        {this.props.textBox}
...
export default withRouter(FratOptions);
