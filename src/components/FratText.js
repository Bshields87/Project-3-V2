...
const FratText = () => (
  <div className="game-wrapper">
    <FratOptions
      ...
      items={["Attack her with the same bat you used on her minion.", "Turn off the music."]}
      textBox={
        <div>
          <h3>Welcome to the Frat</h3>
          <p>You arrive at the frat party and realize that the evil <br></br>
            siren is there. Uh oh! What do you do?
          </p>
        </div>
      }
    />
