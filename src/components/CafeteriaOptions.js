...
import CafeteriaContainer from "./CafeteriaContainer";
import { withRouter } from "react-router";

class CafeteriaOptions extends React.Component {
  constructor(props) {
    super(props);
    this.itemRefs = [];
    this.state = {
  ...
  render() {
    return (
      <CafeteriaContainer style={{ ...this.props.style, paddingLeft: "44px" }}>
        {this.props.textBox}
...
export default withRouter(CafeteriaOptions);
