  ...
  function attemptMove(direction) {
    ...
    switch (observeLocation(oldPosition, newPosition)) {
      case 10:
        ...
        return (window.location.href = "/dorm");
      // break;
      case 11:
      ...
      case 12:
        ...
        return (window.location.href = "/frathouse");
      // break;
      case 13:
        console.log("get swol bruh");
        return (window.location.href = "/gym");
      //break;
      case 14:
        console.log("num nums motherfucker");
        return (window.location.href = "/cafeteria");
      // break;
      default:
